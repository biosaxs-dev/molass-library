...
<!-- REMOVED (Feb 2, 2026): Reference to modeling-vs-model_free repository (now private, may be restored later)
Detailed evidence extraction, mathematical analysis of regularization behavior, and computational validation of these documented limitations is provided in a companion research repository [@takahashi2026modeling].
-->
