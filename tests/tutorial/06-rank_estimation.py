...
def test_004_compute_scds():
    ...
    assert scds == pytest.approx(expected, abs=0.3)  # abs=0.3: accommodates optimizer variation across numpy/scipy versions
...
def test_006_another_sample():
    ...
    assert scds == pytest.approx([5.136732], abs=0.3)  # abs=0.3: accommodates optimizer variation across numpy/scipy versions
