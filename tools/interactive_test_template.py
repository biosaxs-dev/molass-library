# Define abs_test_path from template variable
abs_test_path = r'{abs_test_path}'
...
print("[DEBUG] MOLASS_ENABLE_PLOTS at script start:", os.environ.get('MOLASS_ENABLE_PLOTS'))
